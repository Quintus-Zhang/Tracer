...
if run_dp:
    ...
    c_func_df, v = dp_solver(income_bf_ret, income_ret, sigma_perm, sigma_tran, cond_prob, GAMMA)
...
c_ce_arr = np.zeros(N)
for i in range(N):
    c_proc, inc = generate_consumption_process(income_bf_ret, sigma_perm, sigma_tran, c_func_df)
